...
SIMPLE_L1_CEREMONY_DOMAIN="${SIMPLE_L1_CEREMONY_DOMAIN:-}"
SL1_ISSUER_CEREMONY_MAP="${SL1_ISSUER_CEREMONY_MAP:-}"
...
DIGITAL_GOODS_SOURCE_ENABLED="${DIGITAL_GOODS_SOURCE_ENABLED:-false}"
...
apply_simple_l1_env() {
    ...
    set_env_var "SIMPLE_L1_CEREMONY_DOMAIN" "$SIMPLE_L1_CEREMONY_DOMAIN"
    set_env_var "SL1_ISSUER_CEREMONY_MAP" "$SL1_ISSUER_CEREMONY_MAP"
