...
set_env_var "SIMPLE_L1_CEREMONY_DOMAIN" "${SIMPLE_L1_CEREMONY_DOMAIN:-$(get_env_var SIMPLE_L1_CEREMONY_DOMAIN)}"
set_env_var "SL1_ISSUER_CEREMONY_MAP" "${SL1_ISSUER_CEREMONY_MAP:-$(get_env_var SL1_ISSUER_CEREMONY_MAP)}"
