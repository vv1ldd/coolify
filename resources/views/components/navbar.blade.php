        ...
        <li class="flex-1 overflow-y-auto overflow-x-hidden sidebar-scroll pr-1">
            <ul role="list" class="flex flex-col h-full">
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Realm Operations" {{ wireNavigate() }}
                            class="{{ request()->is('realm-operations*') ? 'menu-item menu-item-active' : 'menu-item' }}"
                            href="{{ route('realm.operations.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="menu-item-icon" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span class="menu-item-label tracking-tight">Realm Operations</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a title="Cloudflare" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label tracking-tight">Cloudflare</span>
                        </a>
                    </li>
